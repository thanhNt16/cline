...
export const BANNER_DATA: BannerCardData[] = [
	...
	// Minimax free promo banner
	{
		...
		description: "SOTA coding capability with lightning fast inference, free in CellockAI.",
		actions: [
			{
				title: "Try now",
				action: BannerActionType.SetModel,
	...
	// ChatGPT integration banner
	{
		...
		icon: "megaphone",
		title: "Use ChatGPT with CellockAI",
		description:
			"Bring your ChatGPT subscription to CellockAI! Use your existing plan directly with no per token costs or API keys to manage.",
		actions: [
			{
				title: "Connect",
	...
	// Info banner with inline link
	{
		id: "info-banner-v1",
		icon: "lightbulb",
		title: "Use CellockAI in Right Sidebar",
		description:
			"For the best experience, drag the CellockAI icon to your right sidebar. This keeps your file explorer and editor visible while you chat with CellockAI, making it easier to navigate your codebase and see changes in real-time. [See how →](https://docs.cellock.ai/features/customization/opening-cline-in-sidebar)",
	},
]
