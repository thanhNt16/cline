...
const FEATURE_TIPS: FeatureTipItem[] = [
	{
		text: 'Enable "Double-Check Completion" in settings to have CellockAI verify its work before finishing a task.',
	},
	{
		text: "Add a rule file under .cellockai/rules/ in your project root to give CellockAI project-specific instructions.",
	},
	{
		text: "Switch to Plan Mode to discuss and plan an approach before CellockAI takes action.",
	},
	{
		text: "Use @ in the chat input to add files, folders, or URLs as context for your task.",
	},
	{
		text: "Set up MCP Servers to give CellockAI access to external tools and APIs.",
	},
	{
		text: "CellockAI creates checkpoints after changes — you can always restore to a previous state.",
	},
	{
	...
	{
		text: "Use the quote button to select text from CellockAI's response and reference it in your reply.",
	},
	{
		text: "You can drag and drop images into the chat to share screenshots with CellockAI.",
	},
	{
		text: "CellockAI can browse websites — ask it to test your local dev server in the browser.",
	},
	{
