...
const agentFeatures: FeatureToggle[] = [
	{
		id: "subagents",
		label: "Subagents",
		description: "Let CellockAI run focused subagents in parallel to explore the codebase for you.",
...
const editorFeatures: FeatureToggle[] = [
	{
		...
		label: "Feature Tips",
		description: "Show rotating tips during the thinking phase to help you discover CellockAI features.",
	...
	},
	{
		id: "worktrees",
		label: "Worktrees",
		description: "Enables git worktree management for running parallel CellockAI tasks.",
...
const experimentalFeatures: FeatureToggle[] = [
	...
	},
	{
		...
		description: "Sometimes CellockAI just isn't feeling it today. For entertainment purposes only.",
