...
export class DocsIndexServiceClient extends ProtoBusClient {
	...
	static async crawlUrl(request: proto.cline.CrawlUrlRequest): Promise<proto.cline.CrawlUrlResponse> {
		return DocsIndexServiceClient.makeUnaryRequest(
			"crawlUrl",
			request,
			proto.cline.CrawlUrlRequest.toJSON,
			proto.cline.CrawlUrlResponse.fromJSON,
		)
	}
	static async listCrawls(request: proto.cline.ListCrawlsRequest): Promise<proto.cline.ListCrawlsResponse> {
		return DocsIndexServiceClient.makeUnaryRequest(
			"listCrawls",
			request,
			proto.cline.ListCrawlsRequest.toJSON,
			proto.cline.ListCrawlsResponse.fromJSON,
		)
	}
	static async getCrawl(request: proto.cline.GetCrawlRequest): Promise<proto.cline.GetCrawlResponse> {
		return DocsIndexServiceClient.makeUnaryRequest(
			"getCrawl",
			request,
			proto.cline.GetCrawlRequest.toJSON,
			proto.cline.GetCrawlResponse.fromJSON,
		)
	}
	static async refreshCrawl(request: proto.cline.RefreshCrawlRequest): Promise<proto.cline.RefreshCrawlResponse> {
		return DocsIndexServiceClient.makeUnaryRequest(
			"refreshCrawl",
			request,
			proto.cline.RefreshCrawlRequest.toJSON,
			proto.cline.RefreshCrawlResponse.fromJSON,
		)
	}
	static async deleteCrawl(request: proto.cline.DeleteCrawlRequest): Promise<proto.cline.DeleteCrawlResponse> {
		return DocsIndexServiceClient.makeUnaryRequest(
			"deleteCrawl",
			request,
			proto.cline.DeleteCrawlRequest.toJSON,
			proto.cline.DeleteCrawlResponse.fromJSON,
		)
	}
...
export class MarketplaceServiceClient extends ProtoBusClient {
	...
	static async searchGithubSkills(
		request: proto.cline.SearchGithubSkillsRequest,
	): Promise<proto.cline.SearchGithubSkillsResponse> {
		return MarketplaceServiceClient.makeUnaryRequest(
			"searchGithubSkills",
			request,
			proto.cline.SearchGithubSkillsRequest.toJSON,
			proto.cline.SearchGithubSkillsResponse.fromJSON,
		)
	}
}
...
export class UiServiceClient extends ProtoBusClient {
	...
	static async logToOutput(request: proto.cline.StringRequest): Promise<proto.cline.Empty> {
		return UiServiceClient.makeUnaryRequest(
			"logToOutput",
			request,
			proto.cline.StringRequest.toJSON,
