...
import { Empty, EmptyRequest, Int64, Metadata as Metadata1, String, StringArrayRequest, StringRequest } from "./common";
...
export interface EditMessageAndRegenerateRequest {
  metadata: Metadata1 | undefined;
  messageTs: number;
  text: string;
  images: string[];
...
function createBaseEditMessageAndRegenerateRequest(): EditMessageAndRegenerateRequest {
  return { metadata: undefined, messageTs: 0, text: "", images: [], files: [], restoreWorkspace: false };
}

export const EditMessageAndRegenerateRequest: MessageFns<EditMessageAndRegenerateRequest> = {
  encode(message: EditMessageAndRegenerateRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.metadata !== undefined) {
      Metadata1.encode(message.metadata, writer.uint32(10).fork()).join();
    }
    ...
    if (message.restoreWorkspace !== false) {
      writer.uint32(48).bool(message.restoreWorkspace);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): EditMessageAndRegenerateRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseEditMessageAndRegenerateRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 6: {
          ...
          message.restoreWorkspace = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): EditMessageAndRegenerateRequest {
    return {
      metadata: isSet(object.metadata) ? Metadata1.fromJSON(object.metadata) : undefined,
      ...
      images: globalThis.Array.isArray(object?.images) ? object.images.map((e: any) => globalThis.String(e)) : [],
      files: globalThis.Array.isArray(object?.files) ? object.files.map((e: any) => globalThis.String(e)) : [],
      restoreWorkspace: isSet(object.restoreWorkspace)
        ? globalThis.Boolean(object.restoreWorkspace)
        : isSet(object.restore_workspace)
        ? globalThis.Boolean(object.restore_workspace)
        : false,
    };
  },

  toJSON(message: EditMessageAndRegenerateRequest): unknown {
    const obj: any = {};
    if (message.metadata !== undefined) {
      obj.metadata = Metadata1.toJSON(message.metadata);
    }
    ...
    if (message.restoreWorkspace !== false) {
      obj.restoreWorkspace = message.restoreWorkspace;
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<EditMessageAndRegenerateRequest>, I>>(base?: I): EditMessageAndRegenerateRequest {
    return EditMessageAndRegenerateRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EditMessageAndRegenerateRequest>, I>>(
    object: I,
  ): EditMessageAndRegenerateRequest {
    const message = createBaseEditMessageAndRegenerateRequest();
    message.metadata = (object.metadata !== undefined && object.metadata !== null)
      ? Metadata1.fromPartial(object.metadata)
      : undefined;
    ...
    message.images = object.images?.map((e) => e) || [];
    message.files = object.files?.map((e) => e) || [];
    message.restoreWorkspace = object.restoreWorkspace ?? false;
    return message;
  },
};
...
export const TaskServiceDefinition = {
  ...
  methods: {
    ...
    editMessageAndRegenerate: {
      ...
      requestType: EditMessageAndRegenerateRequest as typeof EditMessageAndRegenerateRequest,
      requestStream: false,
      responseType: Empty as typeof Empty,
      responseStream: false,
      options: {},
...
export const TaskServiceService = {
  ...
  /** Cancels a queued prompt by ID */
  cancelQueuedPrompt: {
    path: "/cline.TaskService/cancelQueuedPrompt" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Edits a previous user message, truncates following conversation, and regenerates */
  editMessageAndRegenerate: {
    path: "/cline.TaskService/editMessageAndRegenerate" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EditMessageAndRegenerateRequest): Buffer =>
      Buffer.from(EditMessageAndRegenerateRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EditMessageAndRegenerateRequest =>
      EditMessageAndRegenerateRequest.decode(value),
    responseSerialize: (value: Empty): Buffer => Buffer.from(Empty.encode(value).finish()),
    responseDeserialize: (value: Buffer): Empty => Empty.decode(value),
  },
  /** Records task feedback (thumbs up/down) */
...
export interface TaskServiceServer extends UntypedServiceImplementation {
  ...
  /** Cancels a queued prompt by ID */
  cancelQueuedPrompt: handleUnaryCall<StringRequest, Empty>;
  /** Cancels the currently running background command */
  ...
  /** Edits a previous user message, truncates following conversation, and regenerates */
  editMessageAndRegenerate: handleUnaryCall<EditMessageAndRegenerateRequest, Empty>;
  /** Records task feedback (thumbs up/down) */
