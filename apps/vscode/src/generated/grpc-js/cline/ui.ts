...
export const IntentEvent: MessageFns<IntentEvent> = {
  ...
  create<I extends Exact<DeepPartial<IntentEvent>, I>>(base?: I): IntentEvent {
    return IntentEvent.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<IntentEvent>, I>>(object: I): IntentEvent {
    const message = createBaseIntentEvent();
...
export const UiServiceService = {
  ...
  /** Subscribe to customize button clicked events */
  subscribeToMarketplaceButtonClicked: {
    path: "/cline.UiService/subscribeToMarketplaceButtonClicked" as const,
    requestStream: false as const,
    responseStream: true as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  /** Tracks intent signals before task creation or first model activity */
  trackIntent: {
    path: "/cline.UiService/trackIntent" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: IntentEvent): Buffer => Buffer.from(IntentEvent.encode(value).finish()),
    requestDeserialize: (value: Buffer): IntentEvent => IntentEvent.decode(value),
    responseSerialize: (value: Empty): Buffer => Buffer.from(Empty.encode(value).finish()),
    responseDeserialize: (value: Buffer): Empty => Empty.decode(value),
  },
} as const;
...
export interface UiServiceServer extends UntypedServiceImplementation {
  ...
  /** Subscribe to customize button clicked events */
  subscribeToMarketplaceButtonClicked: handleServerStreamingCall<EmptyRequest, Empty>;
  /** Subscribe to history button click events */
  ...
  /** Tracks intent signals before task creation or first model activity */
  trackIntent: handleUnaryCall<IntentEvent, Empty>;
}
...
export interface UiServiceClient extends Client {
  ...
  /** Tracks intent signals before task creation or first model activity */
  trackIntent(request: IntentEvent, callback: (error: ServiceError | null, response: Empty) => void): ClientUnaryCall;
  trackIntent(
    request: IntentEvent,
    metadata: Metadata,
    callback: (error: ServiceError | null, response: Empty) => void,
