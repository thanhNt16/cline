...
export const DocsIndexServiceService = {
  ...
  projectStats: {
    path: "/cline.DocsIndexService/projectStats" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: ProjectStatsRequest): Buffer => Buffer.from(ProjectStatsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): ProjectStatsRequest => ProjectStatsRequest.decode(value),
    responseSerialize: (value: ProjectStatsResponse): Buffer =>
  ...
  indexDocsProject: {
    ...
    requestSerialize: (value: DocsIndexProjectRequest): Buffer =>
      Buffer.from(DocsIndexProjectRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): DocsIndexProjectRequest => DocsIndexProjectRequest.decode(value),
    responseSerialize: (value: DocsIndexProjectResponse): Buffer =>
      Buffer.from(DocsIndexProjectResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): DocsIndexProjectResponse => DocsIndexProjectResponse.decode(value),
  },
  indexUrl: {
  ...
  pollIndexJob: {
    path: "/cline.DocsIndexService/pollIndexJob" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: PollIndexJobRequest): Buffer => Buffer.from(PollIndexJobRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): PollIndexJobRequest => PollIndexJobRequest.decode(value),
    responseSerialize: (value: PollIndexJobResponse): Buffer =>
      Buffer.from(PollIndexJobResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): PollIndexJobResponse => PollIndexJobResponse.decode(value),
  },
} as const;
...
export interface DocsIndexServiceServer extends UntypedServiceImplementation {
  ...
  pollIndexJob: handleUnaryCall<PollIndexJobRequest, PollIndexJobResponse>;
}
...
export interface DocsIndexServiceClient extends Client {
  ...
  pollIndexJob(
    ...
    callback: (error: ServiceError | null, response: PollIndexJobResponse) => void,
  ): ClientUnaryCall;
  pollIndexJob(
    request: PollIndexJobRequest,
    metadata: Metadata,
