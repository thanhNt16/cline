...
export interface UpdateSettingsRequest {
  ...
  worktreesEnabled?: boolean | undefined;
  showFeatureTips?: boolean | undefined;
  compactionStrategy?: string | undefined;
}
...
/** Model Profiles — OpenAI-compatible provider presets managed per-workspace. */
...
export const Settings: MessageFns<Settings> = {
  encode(message: Settings, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.planModeApiProvider !== undefined) {
      writer.uint32(994).string(message.planModeApiProvider);
    }
    if (message.actModeApiProvider !== undefined) {
      writer.uint32(1002).string(message.actModeApiProvider);
    }
    ...
    if (message.planModeClinePassModelId !== undefined) {
      writer.uint32(1466).string(message.planModeClinePassModelId);
    }
    if (message.planModeClinePassModelInfo !== undefined) {
      OpenRouterModelInfo.encode(message.planModeClinePassModelInfo, writer.uint32(1474).fork()).join();
    }
    if (message.actModeClinePassModelId !== undefined) {
      writer.uint32(1482).string(message.actModeClinePassModelId);
    }
    if (message.actModeClinePassModelInfo !== undefined) {
      OpenRouterModelInfo.encode(message.actModeClinePassModelInfo, writer.uint32(1490).fork()).join();
    }
    return writer;
  },
...
export const UpdateSettingsRequest: MessageFns<UpdateSettingsRequest> = {
  encode(message: UpdateSettingsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.compactionStrategy !== undefined) {
      writer.uint32(354).string(message.compactionStrategy);
    }
    return writer;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<UpdateSettingsRequest>, I>>(object: I): UpdateSettingsRequest {
    ...
    message.worktreesEnabled = object.worktreesEnabled ?? undefined;
    message.showFeatureTips = object.showFeatureTips ?? undefined;
    message.compactionStrategy = object.compactionStrategy ?? undefined;
    return message;
  },
};
...
export const OnboardingProgressRequest: MessageFns<OnboardingProgressRequest> = {
  encode(message: OnboardingProgressRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.page !== undefined) {
      writer.uint32(42).string(message.page);
    }
    if (message.pageVariant !== undefined) {
      writer.uint32(50).string(message.pageVariant);
    }
    if (message.userType !== undefined) {
      writer.uint32(58).string(message.userType);
    }
    if (message.destinationStep !== undefined) {
      writer.uint32(64).int32(message.destinationStep);
    }
    if (message.destinationPage !== undefined) {
      writer.uint32(74).string(message.destinationPage);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.pageVariant = reader.string();
          continue;
        }
        case 7: {
          if (tag !== 58) {
        ...
        case 8: {
          ...
          message.destinationStep = reader.int32();
          continue;
        }
        case 9: {
          if (tag !== 74) {
          ...
          message.destinationPage = reader.string();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): OnboardingProgressRequest {
    return {
      ...
      pageVariant: isSet(object.pageVariant)
        ? globalThis.String(object.pageVariant)
        : isSet(object.page_variant)
        ? globalThis.String(object.page_variant)
        : undefined,
      userType: isSet(object.userType)
        ...
        : undefined,
      destinationStep: isSet(object.destinationStep)
        ? globalThis.Number(object.destinationStep)
        : isSet(object.destination_step)
        ? globalThis.Number(object.destination_step)
        : undefined,
      destinationPage: isSet(object.destinationPage)
        ? globalThis.String(object.destinationPage)
        : isSet(object.destination_page)
        ? globalThis.String(object.destination_page)
        : undefined,
    };
  },
  ...
  toJSON(message: OnboardingProgressRequest): unknown {
    ...
    if (message.pageVariant !== undefined) {
      obj.pageVariant = message.pageVariant;
    }
    if (message.userType !== undefined) {
      obj.userType = message.userType;
    }
    if (message.destinationStep !== undefined) {
      obj.destinationStep = Math.round(message.destinationStep);
    }
    if (message.destinationPage !== undefined) {
      obj.destinationPage = message.destinationPage;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<OnboardingProgressRequest>, I>>(object: I): OnboardingProgressRequest {
    ...
    message.pageVariant = object.pageVariant ?? undefined;
    message.userType = object.userType ?? undefined;
    message.destinationStep = object.destinationStep ?? undefined;
    message.destinationPage = object.destinationPage ?? undefined;
    return message;
  },
};
...
function createBaseModelProfile(): ModelProfile {
  return { id: "", name: "", baseUrl: "", modelId: "", apiKey: "" };
}

export const ModelProfile: MessageFns<ModelProfile> = {
  encode(message: ModelProfile, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ModelProfile {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseModelProfile();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): ModelProfile {
    return {
      id: isSet(object.id) ? globalThis.String(object.id) : "",
      name: isSet(object.name) ? globalThis.String(object.name) : "",
  ...
  toJSON(message: ModelProfile): unknown {
    const obj: any = {};
    if (message.id !== "") {
      obj.id = message.id;
    }
  ...
  create<I extends Exact<DeepPartial<ModelProfile>, I>>(base?: I): ModelProfile {
    return ModelProfile.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ModelProfile>, I>>(object: I): ModelProfile {
    const message = createBaseModelProfile();
    message.id = object.id ?? "";
    message.name = object.name ?? "";
...
function createBaseProfilesResponse(): ProfilesResponse {
  return { activeProfileId: "", profiles: [] };
}

export const ProfilesResponse: MessageFns<ProfilesResponse> = {
  encode(message: ProfilesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.activeProfileId !== "") {
      writer.uint32(10).string(message.activeProfileId);
    }
    for (const v of message.profiles) {
      ModelProfile.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ProfilesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseProfilesResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.activeProfileId = reader.string();
          continue;
        }
        case 2: {
          if (tag !== 18) {
          ...
          message.profiles.push(ModelProfile.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ProfilesResponse {
    return {
      activeProfileId: isSet(object.activeProfileId)
        ? globalThis.String(object.activeProfileId)
        : isSet(object.active_profile_id)
        ? globalThis.String(object.active_profile_id)
        : "",
      profiles: globalThis.Array.isArray(object?.profiles)
        ? object.profiles.map((e: any) => ModelProfile.fromJSON(e))
        : [],
    };
  },

  toJSON(message: ProfilesResponse): unknown {
    const obj: any = {};
    if (message.activeProfileId !== "") {
      obj.activeProfileId = message.activeProfileId;
    }
    if (message.profiles?.length) {
      obj.profiles = message.profiles.map((e) => ModelProfile.toJSON(e));
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<ProfilesResponse>, I>>(base?: I): ProfilesResponse {
    return ProfilesResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ProfilesResponse>, I>>(object: I): ProfilesResponse {
    const message = createBaseProfilesResponse();
    message.activeProfileId = object.activeProfileId ?? "";
    message.profiles = object.profiles?.map((e) => ModelProfile.fromPartial(e)) || [];
    return message;
  },
};

function createBaseUpsertProfileRequest(): UpsertProfileRequest {
  return { profile: undefined };
}

export const UpsertProfileRequest: MessageFns<UpsertProfileRequest> = {
  encode(message: UpsertProfileRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.profile !== undefined) {
      ModelProfile.encode(message.profile, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UpsertProfileRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUpsertProfileRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.profile = ModelProfile.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): UpsertProfileRequest {
    return { profile: isSet(object.profile) ? ModelProfile.fromJSON(object.profile) : undefined };
  },

  toJSON(message: UpsertProfileRequest): unknown {
    const obj: any = {};
    if (message.profile !== undefined) {
      obj.profile = ModelProfile.toJSON(message.profile);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<UpsertProfileRequest>, I>>(base?: I): UpsertProfileRequest {
    return UpsertProfileRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<UpsertProfileRequest>, I>>(object: I): UpsertProfileRequest {
    const message = createBaseUpsertProfileRequest();
    message.profile = (object.profile !== undefined && object.profile !== null)
      ? ModelProfile.fromPartial(object.profile)
      : undefined;
    return message;
  },
};

function createBaseSetActiveProfileRequest(): SetActiveProfileRequest {
  return { id: "" };
}

export const SetActiveProfileRequest: MessageFns<SetActiveProfileRequest> = {
  encode(message: SetActiveProfileRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetActiveProfileRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSetActiveProfileRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): SetActiveProfileRequest {
    return { id: isSet(object.id) ? globalThis.String(object.id) : "" };
  },

  toJSON(message: SetActiveProfileRequest): unknown {
    const obj: any = {};
    if (message.id !== "") {
      obj.id = message.id;
    }
  ...
  create<I extends Exact<DeepPartial<SetActiveProfileRequest>, I>>(base?: I): SetActiveProfileRequest {
    return SetActiveProfileRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SetActiveProfileRequest>, I>>(object: I): SetActiveProfileRequest {
    const message = createBaseSetActiveProfileRequest();
    message.id = object.id ?? "";
    return message;
  },
...
export const StateServiceDefinition = {
  ...
  methods: {
    ...
    captureOnboardingProgress: {
      ...
      requestType: OnboardingProgressRequest as typeof OnboardingProgressRequest,
      requestStream: false,
      responseType: Empty as typeof Empty,
      responseStream: false,
      options: {},
    ...
    getProfiles: {
      ...
      requestType: EmptyRequest as typeof EmptyRequest,
      requestStream: false,
      responseType: ProfilesResponse as typeof ProfilesResponse,
      responseStream: false,
      options: {},
    },
    upsertProfile: {
      name: "upsertProfile",
      requestType: UpsertProfileRequest as typeof UpsertProfileRequest,
      requestStream: false,
      responseType: ProfilesResponse as typeof ProfilesResponse,
      responseStream: false,
      options: {},
    ...
    setActiveProfile: {
      ...
      requestType: SetActiveProfileRequest as typeof SetActiveProfileRequest,
      requestStream: false,
      responseType: ProfilesResponse as typeof ProfilesResponse,
      responseStream: false,
      options: {},
    ...
    deleteProfile: {
      name: "deleteProfile",
      requestType: DeleteProfileRequest as typeof DeleteProfileRequest,
      requestStream: false,
      responseType: ProfilesResponse as typeof ProfilesResponse,
      responseStream: false,
      options: {},
...
export const StateServiceService = {
  ...
  getProfiles: {
    path: "/cline.StateService/getProfiles" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
    responseSerialize: (value: ProfilesResponse): Buffer => Buffer.from(ProfilesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): ProfilesResponse => ProfilesResponse.decode(value),
  },
  upsertProfile: {
    path: "/cline.StateService/upsertProfile" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: UpsertProfileRequest): Buffer => Buffer.from(UpsertProfileRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): UpsertProfileRequest => UpsertProfileRequest.decode(value),
    responseSerialize: (value: ProfilesResponse): Buffer => Buffer.from(ProfilesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): ProfilesResponse => ProfilesResponse.decode(value),
  },
  setActiveProfile: {
    path: "/cline.StateService/setActiveProfile" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: SetActiveProfileRequest): Buffer =>
      Buffer.from(SetActiveProfileRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): SetActiveProfileRequest => SetActiveProfileRequest.decode(value),
    responseSerialize: (value: ProfilesResponse): Buffer => Buffer.from(ProfilesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): ProfilesResponse => ProfilesResponse.decode(value),
  },
  deleteProfile: {
    path: "/cline.StateService/deleteProfile" as const,
    requestStream: false as const,
    responseStream: false as const,
...
export interface StateServiceServer extends UntypedServiceImplementation {
  ...
  getProfiles: handleUnaryCall<EmptyRequest, ProfilesResponse>;
  upsertProfile: handleUnaryCall<UpsertProfileRequest, ProfilesResponse>;
  setActiveProfile: handleUnaryCall<SetActiveProfileRequest, ProfilesResponse>;
  deleteProfile: handleUnaryCall<DeleteProfileRequest, ProfilesResponse>;
}
...
export interface StateServiceClient extends Client {
  ...
  getProfiles(
    request: EmptyRequest,
    callback: (error: ServiceError | null, response: ProfilesResponse) => void,
  ): ClientUnaryCall;
  getProfiles(
    request: EmptyRequest,
    metadata: Metadata,
