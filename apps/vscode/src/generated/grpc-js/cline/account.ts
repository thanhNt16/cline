...
export const AccountServiceDefinition = {
  ...
  methods: {
    ...
    submitLimitIncreaseRequest: {
      ...
      requestType: EmptyRequest as typeof EmptyRequest,
      requestStream: false,
      responseType: SubmitLimitIncreaseResponse as typeof SubmitLimitIncreaseResponse,
      responseStream: false,
      options: {},
    },
  },
...
export const AccountServiceService = {
  ...
  submitLimitIncreaseRequest: {
    ...
    responseDeserialize: (value: Buffer): SubmitLimitIncreaseResponse => SubmitLimitIncreaseResponse.decode(value),
  },
} as const;
...
export interface AccountServiceServer extends UntypedServiceImplementation {
   ...
   * Called when the user hits a SPEND_LIMIT_EXCEEDED (429) error and clicks "Request Increase".
   */
  submitLimitIncreaseRequest: handleUnaryCall<EmptyRequest, SubmitLimitIncreaseResponse>;
}
...
export interface AccountServiceClient extends Client {
  ...
  submitLimitIncreaseRequest(
    request: EmptyRequest,
    callback: (error: ServiceError | null, response: SubmitLimitIncreaseResponse) => void,
  ): ClientUnaryCall;
  submitLimitIncreaseRequest(
    request: EmptyRequest,
    metadata: Metadata,
