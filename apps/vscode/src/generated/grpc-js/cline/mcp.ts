...
export const AddStdioMcpServerRequest: MessageFns<AddStdioMcpServerRequest> = {
  ...
  create<I extends Exact<DeepPartial<AddStdioMcpServerRequest>, I>>(base?: I): AddStdioMcpServerRequest {
    return AddStdioMcpServerRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AddStdioMcpServerRequest>, I>>(object: I): AddStdioMcpServerRequest {
    const message = createBaseAddStdioMcpServerRequest();
    message.metadata = (object.metadata !== undefined && object.metadata !== null)
      ? Metadata1.fromPartial(object.metadata)
      : undefined;
...
export const AddStdioMcpServerRequest_EnvEntry: MessageFns<AddStdioMcpServerRequest_EnvEntry> = {
  ...
  create<I extends Exact<DeepPartial<AddStdioMcpServerRequest_EnvEntry>, I>>(
    base?: I,
  ): AddStdioMcpServerRequest_EnvEntry {
    return AddStdioMcpServerRequest_EnvEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AddStdioMcpServerRequest_EnvEntry>, I>>(
    object: I,
  ): AddStdioMcpServerRequest_EnvEntry {
    const message = createBaseAddStdioMcpServerRequest_EnvEntry();
...
export const McpServiceService = {
  ...
  addStdioMcpServer: {
    path: "/cline.McpService/addStdioMcpServer" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: AddStdioMcpServerRequest): Buffer =>
      Buffer.from(AddStdioMcpServerRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): AddStdioMcpServerRequest => AddStdioMcpServerRequest.decode(value),
    responseSerialize: (value: McpServers): Buffer => Buffer.from(McpServers.encode(value).finish()),
    responseDeserialize: (value: Buffer): McpServers => McpServers.decode(value),
  },
  restartMcpServer: {
...
export interface McpServiceServer extends UntypedServiceImplementation {
  ...
  addStdioMcpServer: handleUnaryCall<AddStdioMcpServerRequest, McpServers>;
