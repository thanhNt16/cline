...
export function addProtobusServices(
    ...
    server.addService(cline.AccountServiceService, {
        ...
        subscribeToAuthStatusUpdate: wrapStreamingResponse<cline.EmptyRequest,cline.AuthState>(subscribeToAuthStatusUpdate, controller),
         ...
         submitLimitIncreaseRequest: wrapper<cline.EmptyRequest,cline.SubmitLimitIncreaseResponse>(submitLimitIncreaseRequest, controller),
    });
    ...
    // CodebaseMemory Service
    server.addService(cline.CodebaseMemoryServiceService, {
         getStatus: wrapper<cline.EmptyRequest,cline.CodebaseMemoryStatus>(getStatus, controller),
        indexProject: wrapStreamingResponse<cline.IndexProjectRequest,cline.IndexProgressEvent>(indexProject, controller),
        reindexProject: wrapStreamingResponse<cline.EmptyRequest,cline.IndexProgressEvent>(reindexProject, controller),
        downloadBinary: wrapStreamingResponse<cline.EmptyRequest,cline.IndexProgressEvent>(downloadBinary, controller),
         viewGraph: wrapper<cline.EmptyRequest,cline.ViewGraphResponse>(viewGraph, controller),
         stopGraphServer: wrapper<cline.EmptyRequest,cline.Empty>(stopGraphServer, controller),
         listTools: wrapper<cline.EmptyRequest,cline.CodebaseMemoryTools>(listTools, controller),
    });
    ...
    // Marketplace Service
    server.addService(cline.MarketplaceServiceService, {
         getMarketplaceCatalog: wrapper<cline.EmptyRequest,cline.MarketplaceCatalog>(getMarketplaceCatalog, controller),
         listMarketplaceLocalInstalledEntries: wrapper<cline.EmptyRequest,cline.MarketplaceLocalInstalledEntries>(listMarketplaceLocalInstalledEntries, controller),
         listMarketplaceInstalledEntries: wrapper<cline.MarketplaceEntriesRequest,cline.MarketplaceInstalledEntries>(listMarketplaceInstalledEntries, controller),
         installMarketplaceEntry: wrapper<cline.MarketplaceEntryRequest,cline.MarketplaceInstallResult>(installMarketplaceEntry, controller),
         uninstallMarketplaceEntry: wrapper<cline.MarketplaceEntryRequest,cline.MarketplaceInstallResult>(uninstallMarketplaceEntry, controller),
         toggleMarketplaceLocalInstalledEntry: wrapper<cline.ToggleMarketplaceLocalInstalledEntryRequest,cline.MarketplaceLocalInstalledEntries>(toggleMarketplaceLocalInstalledEntry, controller),
         uninstallMarketplaceLocalInstalledEntry: wrapper<cline.MarketplaceLocalInstalledEntryRequest,cline.MarketplaceInstallResult>(uninstallMarketplaceLocalInstalledEntry, controller),
    });
    ...
    server.addService(cline.McpServiceService, {
         ...
         addStdioMcpServer: wrapper<cline.AddStdioMcpServerRequest,cline.McpServers>(addStdioMcpServer, controller),
    ...
    server.addService(cline.ModelsServiceService, {
        ...
        subscribeToLiteLlmModels: wrapStreamingResponse<cline.EmptyRequest,cline.OpenRouterCompatibleModelInfo>(subscribeToLiteLlmModels, controller),
         ...
         listProviders: wrapper<cline.Empty,cline.ProviderListingsResponse>(listProviders, controller),
         resolveProviderModels: wrapper<cline.ResolveProviderModelsRequest,cline.ProviderModelsResponse>(resolveProviderModels, controller),
         resolveModelInfo: wrapper<cline.ResolveModelInfoRequest,cline.ResolveModelInfoResponse>(resolveModelInfo, controller),
         readProviderConfig: wrapper<cline.StringRequest,cline.ProviderConfigResponse>(readProviderConfig, controller),
         writeProviderConfig: wrapper<cline.WriteProviderConfigRequest,cline.ProviderConfigResponse>(writeProviderConfig, controller),
         commitModelSelection: wrapper<cline.CommitModelSelectionRequest,cline.Empty>(commitModelSelection, controller),
    });
    ...
    // RemoteConfig Service
    server.addService(cline.RemoteConfigServiceService, {
         getRemoteConfigSettings: wrapper<cline.Empty,cline.RemoteConfigSettingsResponse>(getRemoteConfigSettings, controller),
         toggleRemoteConfigSetting: wrapper<cline.StringRequest,cline.RemoteConfigSetting>(toggleRemoteConfigSetting, controller),
    });
    ...
    server.addService(cline.StateServiceService, {
        ...
        subscribeToState: wrapStreamingResponse<cline.EmptyRequest,cline.State>(subscribeToState, controller),
         ...
         getProfiles: wrapper<cline.EmptyRequest,cline.ProfilesResponse>(getProfiles, controller),
         upsertProfile: wrapper<cline.UpsertProfileRequest,cline.ProfilesResponse>(upsertProfile, controller),
         setActiveProfile: wrapper<cline.SetActiveProfileRequest,cline.ProfilesResponse>(setActiveProfile, controller),
         deleteProfile: wrapper<cline.DeleteProfileRequest,cline.ProfilesResponse>(deleteProfile, controller),
    });

    // Task Service
    server.addService(cline.TaskServiceService, {
         cancelTask: wrapper<cline.EmptyRequest,cline.Empty>(cancelTask, controller),
         cancelQueuedPrompt: wrapper<cline.StringRequest,cline.Empty>(cancelQueuedPrompt, controller),
         ...
         editMessageAndRegenerate: wrapper<cline.EditMessageAndRegenerateRequest,cline.Empty>(editMessageAndRegenerate, controller),
    ...
    server.addService(cline.UiServiceService, {
        ...
        subscribeToMarketplaceButtonClicked: wrapStreamingResponse<cline.EmptyRequest,cline.Empty>(subscribeToMarketplaceButtonClicked, controller),
        ...
        subscribeToShowWebview: wrapStreamingResponse<cline.EmptyRequest,cline.ShowWebviewEvent>(subscribeToShowWebview, controller),
         ...
         trackIntent: wrapper<cline.IntentEvent,cline.Empty>(trackIntent, controller),
    });
