...
import { Empty, EmptyRequest, Int64, Metadata, String, StringArrayRequest, StringRequest } from "./common";
...
export const EditMessageAndRegenerateRequest: MessageFns<EditMessageAndRegenerateRequest> = {
  ...
  create(base?: DeepPartial<EditMessageAndRegenerateRequest>): EditMessageAndRegenerateRequest {
    return EditMessageAndRegenerateRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<EditMessageAndRegenerateRequest>): EditMessageAndRegenerateRequest {
    const message = createBaseEditMessageAndRegenerateRequest();
    message.metadata = (object.metadata !== undefined && object.metadata !== null)
      ? Metadata.fromPartial(object.metadata)
      : undefined;
...
export interface TaskServiceImplementation<CallContextExt = {}> {
  ...
  /** Cancels a queued prompt by ID */
  cancelQueuedPrompt(request: StringRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /** Cancels the currently running background command */
...
export interface TaskServiceClient<CallOptionsExt = {}> {
  ...
  /** Cancels a queued prompt by ID */
  cancelQueuedPrompt(request: DeepPartial<StringRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /** Cancels the currently running background command */
  ...
  /** Edits a previous user message, truncates following conversation, and regenerates */
  editMessageAndRegenerate(
    request: DeepPartial<EditMessageAndRegenerateRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<Empty>;
  /** Records task feedback (thumbs up/down) */
