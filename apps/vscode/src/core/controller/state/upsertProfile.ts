...
import type { ProfilesResponse, UpsertProfileRequest } from "@shared/proto/cline/state"
 ...
 */
export async function upsertProfile(controller: Controller, request: UpsertProfileRequest): Promise<ProfilesResponse> {
	try {
